                    ...
                    <div className="space-y-6 md:space-y-8">
                        ...
                        <div className="pt-4 flex flex-col sm:flex-row sm:items-center gap-5">
                            ...
                            <div className="flex items-center gap-4">
                                <SocialLink href={SITE_INFO.social.github} label="GitHub">
                                ...
                                <SocialLink href={SITE_INFO.social.bilibili} label="Bilibili" hoverColor="hover:text-pink-400 dark:hover:text-pink-400">
